...
start: token
	_build/dev/rel/gaki_bot/bin/gaki_bot daemon
...
stop:
	_build/dev/rel/gaki_bot/bin/gaki_bot stop

attach:
	_build/dev/rel/gaki_bot/bin/gaki_bot remote

release: deps compile
	mix release

debug: token
	_build/dev/rel/gaki_bot/bin/gaki_bot console
